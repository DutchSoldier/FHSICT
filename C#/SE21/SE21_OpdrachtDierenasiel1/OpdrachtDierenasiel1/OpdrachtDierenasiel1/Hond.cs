...
namespace OpdrachtDierenasiel1
{
    ...
    {
        private int uitlaatdag;
        private int uitlaatmaand;
        private int uitlaatjaar;
        /// <summary>
        ...
        public Hond(string chipnummer, int geboortejaar, string roepnaam, bool gereserveerd, int uitlaatdag, int uitlaatmaand, int uitlaatjaar)
        {
           //moet je nog maken
            ...
            this.uitlaatdag = uitlaatdag;
            this.uitlaatmaand = uitlaatmaand;
            this.uitlaatjaar = uitlaatjaar;
        }
        ...
        public override string GetInfo()
        {
            ...
            h = "Hond: " + chipnummer + ", " + stringjaar + ", " + roepnaam + uitlaatdag + uitlaatmaand + uitlaatjaar;
            if (gereserveerd)
                h = h + ", gereserveerd";
            else
