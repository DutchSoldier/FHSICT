 ...
 *  of the component which is inside of another component.
 */
public class ComponentResizer extends MouseAdapter
{
	...
	public void mouseDragged(MouseEvent e)
	{
        ...
        /**
         * Method which changes the bounds of the resizable component
         * @param source
         * @param direction
         * @param bounds
         * @param pressed
	...
	protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current)
	{
		...
		int height = bounds.height;
                //int dx = current.x - source.getX();
                //int dy = current.y - source.getY();
