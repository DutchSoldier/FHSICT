...
public class KochFractal extends Observable {
    ...
    public void generateEdge(EdgeID edgeToGen){
        if(edgeToGen == EdgeID.Bottom){
            generateBottomEdge();
        } else if(edgeToGen == EdgeID.Left){
            generateLeftEdge();
        } else if (edgeToGen == EdgeID.Right){
            generateRightEdge();
        } else if (edgeToGen == EdgeID.All){
            generateBottomEdge();
            generateLeftEdge();
            generateRightEdge();
        }
