...
public class ItemsFromSellerTest {
    ...
    public void numberOfOfferdItems() {
         ...
         * Would expect 1 to be true, since we offered an item, although i had to implement
         ...
         *  QUESTION:
         *    Explain the result in terms of entity manager and persistance context.
         *  assertEquals 2, because i only add create 2 items, so i'm not really sure where the 3rd would come from
         */
