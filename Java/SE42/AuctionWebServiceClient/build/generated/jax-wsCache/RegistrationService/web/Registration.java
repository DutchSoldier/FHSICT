...
public interface Registration {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "clean", targetNamespace = "http://web/", className = "web.Clean")
    @ResponseWrapper(localName = "cleanResponse", targetNamespace = "http://web/", className = "web.CleanResponse")
    @Action(input = "http://web/Registration/cleanRequest", output = "http://web/Registration/cleanResponse")
    public void clean();
