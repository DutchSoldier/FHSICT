 ...
 * 
 */
@WebServiceClient(name = "RegistrationService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8081/RegistrationManager?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/RegistrationManager?wsdl");
